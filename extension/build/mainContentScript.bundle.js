...
const get_statistics_element = () => {
    return new Promise((resolve) => {
        ...
        let timer;
        timer = setInterval(() => {
            (0,_keyboard_hotkeys_simulate_nerd_stats_hotkey__WEBPACK_IMPORTED_MODULE_1__.simulate_nerd_stats_hotkey)();
            ...
            if (element && outer_element) {
                ...
                if (_config_config__WEBPACK_IMPORTED_MODULE_0__.STATS_INVISIBLE) {
                    outer_element.style.visibility = "hidden";
                }
                if (_config_config__WEBPACK_IMPORTED_MODULE_0__.STATS_NONCLICKABLE) {
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("mainContentScript." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=mainContentScript.bundle.js.map