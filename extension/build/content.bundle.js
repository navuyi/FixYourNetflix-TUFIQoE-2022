...
(function () {
  ...
  reactHotLoader.register(BASE_URL, "BASE_URL", "/Users/navuyi/Desktop/tufiqoe/FixYourNetflix-TUFIQoE-2022/extension/src/utils/http_requests/config.js");
  reactHotLoader.register(backend_urls, "backend_urls", "/Users/navuyi/Desktop/tufiqoe/FixYourNetflix-TUFIQoE-2022/extension/src/utils/http_requests/config.js");
})();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "send_playback_data": () => (/* binding */ send_playback_data)
/* harmony export */ });
...
(function () {
  ...
  reactHotLoader.register(send_playback_data, "send_playback_data", "/Users/navuyi/Desktop/tufiqoe/FixYourNetflix-TUFIQoE-2022/extension/src/utils/http_requests/send_playback_data.js");
})();
...
/***/ "./src/pages/Content/StatsAnalyzer.ts":
/*!********************************************!*\
  !*** ./src/pages/Content/StatsAnalyzer.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _utils_classes_StatisticsMenu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/classes/StatisticsMenu */ "./src/utils/classes/StatisticsMenu.ts");
/* harmony import */ var _utils_classes_CustomLogger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/classes/CustomLogger */ "./src/utils/classes/CustomLogger.ts");
/* harmony import */ var _utils_classes_ChromeStorage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../utils/classes/ChromeStorage */ "./src/utils/classes/ChromeStorage.ts");
...
class StatsAnalyzer {
    constructor() {
        this.init = async () => {
            ...
            this.stats_menu = new _utils_classes_StatisticsMenu__WEBPACK_IMPORTED_MODULE_3__.StatisticsMenu();
        ...
        this.start_recording = async () => {
            ...
            this.interval = setInterval(async () => {
                ...
                /*await*/
                (0,_utils_http_requests_send_playback_data__WEBPACK_IMPORTED_MODULE_2__.send_playback_data)(data, archive);
        ...
        this.logger = new _utils_classes_CustomLogger__WEBPACK_IMPORTED_MODULE_4__.CustomLogger("[StatsAnalyzer]");
        this.chrome_storage = new _utils_classes_ChromeStorage__WEBPACK_IMPORTED_MODULE_5__.ChromeStorage();
    }
    /**
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _StatsAnalyzer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./StatsAnalyzer */ "./src/pages/Content/StatsAnalyzer.ts");
/* harmony import */ var _CustomPlayer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CustomPlayer */ "./src/pages/Content/CustomPlayer.ts");


const init = async () => {
    const statsAnalyzer = new _StatsAnalyzer__WEBPACK_IMPORTED_MODULE_0__.StatsAnalyzer();
    await statsAnalyzer.init();
    const customPlayer = new _CustomPlayer__WEBPACK_IMPORTED_MODULE_1__.CustomPlayer();
...
class ChromeStorage {
    constructor() {
        ...
        this.set_single = async (key, data) => {
            await chrome.storage.local.set({
                [key]: data
            });
        };
        this.get_single = async (key) => {
            const res = await chrome.storage.local.get([key]);
            return res[key];
        };
        this.get_multiple = async (...keys) => {
            return await chrome.storage.local.get([...keys]);
        };
        this.get_experiment_variables = async () => {
            const experiment_variables = await this.get_single("experiment_variables");
            return experiment_variables;
        };
        this.get_experiment_settings = async () => {
            const experiment_settings = await this.get_single("experiment_settings");
            return experiment_settings;
        };
        this.logger = new _CustomLogger__WEBPACK_IMPORTED_MODULE_1__.CustomLogger("[ChromeStorage]");
    }
}
...
/* harmony export */ });
/* harmony import */ var _keyboard_hotkeys_simulate_nerd_stats_hotkey__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../keyboard_hotkeys/simulate_nerd_stats_hotkey */ "./src/utils/keyboard_hotkeys/simulate_nerd_stats_hotkey.js");

const get_statistics_element = () => {
    return new Promise((resolve) => {
        let element;
        let outer_element;
        let timer;
        timer = setInterval(() => {
            (0,_keyboard_hotkeys_simulate_nerd_stats_hotkey__WEBPACK_IMPORTED_MODULE_0__.simulate_nerd_stats_hotkey)();
